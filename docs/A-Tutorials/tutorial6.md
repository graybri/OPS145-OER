...
```bash
ssh yoursenecaid@matrix.senecapolytechnic.ca ~ops145/t6-check-2
```
...
```bash
ssh yoursenecaid@matrix.senecapolytechnic.ca ~ops145/t6-check-3
```
